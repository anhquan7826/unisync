...
class AvahiServer extends DBusRemoteObject {
  AvahiServer(DBusClient client) : super(client, name: 'org.freedesktop.Avahi', path: DBusObjectPath.root) {
    stateChanged =
        DBusRemoteObjectSignalStream(object: this, interface: 'org.freedesktop.Avahi.Server', name: 'StateChanged', signature: DBusSignature('is'))
            .asBroadcastStream()
            .map((signal) => ServerStateChanged(signal));
  }
