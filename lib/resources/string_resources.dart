...
const _stringResources = (
  ...
  devicePair: (
    ...
    id: 'device_pair.id',
    ipAddress: 'device_pair.ip_address',
  ...
  devicesStatus: (
    ...
    addDevice: 'devices_status.add_device',
    noDeviceFound: 'devices_status.no_devices_found',
    noConnectedDevices: 'devices_status.no_connected_devices',
