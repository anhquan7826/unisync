...
class DevicePairView extends StatefulWidget {
  ...
  @override
  State<DevicePairView> createState() => _DevicePairViewState();
}

class _DevicePairViewState extends State<DevicePairView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocListener<DevicePairCubit, DevicePairState>(
        listener: (BuildContext context, DevicePairState state) {
  ...
  void showAddIpDialog() {
    showDialog(
      ...
      if (ip != null) {
        context.getCubit<DevicePairCubit>().connectToIp(ip);
      }
    });
  }
}
